...
FOUNDATION_EXPORT CFStringRef kMRMediaRemoteNowPlayingInfoArtworkIdentifier;
...
FOUNDATION_EXPORT void MRMediaRemoteSetWantsRouteChangeNotifications(Boolean wantsNotifs);
FOUNDATION_EXPORT void MRMediaRemoteSetWantsNowPlayingNotifications(Boolean wantsNotifs);
