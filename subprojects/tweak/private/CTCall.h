...
int CTGetCurrentCallCount(void);
...
BOOL CTCallGetStartTime(CTCallRef call, double *startTime);
BOOL CTCallGetDuration(CTCallRef call, double *duration);
...
void CTCallHistoryInvalidateCaches(void);

void CTCallTimersReset(void);
...
CFArrayRef _CTCallCopyAllCalls(void);
