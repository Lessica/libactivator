...
NSString *const LAActivatorIPCMessageAddListenerAssignment = @"libactivator.request.add-listener-assignment";
NSString *const LAActivatorIPCMessageRemoveListenerAssignment = @"libactivator.request.remove-listener-assignment";
