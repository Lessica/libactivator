...
- `EVENT_SOURCE_ARCHITECTURE.md`：Event definition provider/registry、acquisition source/registry、composition、generation、lifecycle、interest 与 configuration 的长期内部边界。
