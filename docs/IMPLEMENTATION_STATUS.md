...
| Listener images | `iconForListenerName:`, `smallIconForListenerName:`, and `imageForListenerName:usingTemplate:` query listener objects, listener resource bundles, and the remote listener proxy. | Add app-icon provider behavior later with the built-in application listener. |
